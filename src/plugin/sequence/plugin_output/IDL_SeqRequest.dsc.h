...
#ifndef _H_SeqRequest_
#define _H_SeqRequest_
...
_WINDLL_FUNC int DSCINIT_SeqRequest( SeqRequest *pst );

#include "fasterjson.h"

_WINDLL_FUNC int DSCSERIALIZE_JSON_SeqRequest( SeqRequest *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_SeqRequest( SeqRequest *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_SeqRequest_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_SeqRequest( char *encoding , char *buf , int *p_len , SeqRequest *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_SeqRequest_V( char *encoding , char *buf , int *p_len , void *pv );
