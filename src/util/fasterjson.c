		...
		{							\
			...
			{						\
				...
				{					\
					...
					{								\
						if( ( (unsigned char)*(_base_) >= 0x81 && (unsigned char)*(_base_) <= 0xFE ) && ( ( (unsigned char)*(_base_+1) >= 0x40 && (unsigned char)*(_base_+1) <= 0x7E ) || ( (unsigned char)*(_base_+1) >= 0x80 && (unsigned char)*(_base_+1) <= 0xFE ) ) )	\
						{							\
							(_base_)++;					\
						}							\
						else if( (unsigned char)*(_base_) >=0x81 && (unsigned char)*(_base_) <=0xFE && (unsigned char)*(_base_+1) >=0x30 && (unsigned char)*(_base_+1) <=0x39 && (unsigned char)*(_base_+2) >=0x81 && (unsigned char)*(_base_+2) <=0xFE && (unsigned char)*(_base_+3) >=0x30 && (unsigned char)*(_base_+3) <=0x39 )	\
						{							\
							(_base_)+= 3;					\
						}							\
					}								\
