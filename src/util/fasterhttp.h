...
#define HTTP_OPTIONS_FILL_CONNECTION_NONE	0x00
#define HTTP_OPTIONS_FILL_CONNECTION_KEEPALIVE	0x01
#define HTTP_OPTIONS_FILL_CONNECTION_CLOSE	0x02
...
_WINDLL_FUNC int FormatHttpResponseStartLine2( int status_code , struct HttpEnv *e , uint options, int fill_body_with_status_flag , char *format , ... );
...
#define	SetHttpReusePort(_sock_) \
	{ \
		int	onoff = 1; \
		setsockopt( _sock_ , SOL_SOCKET , SO_REUSEPORT , (void *) & onoff , sizeof(int) ); \
	}
