...
#ifndef _H_UhpResponse_
#define _H_UhpResponse_
...
_WINDLL_FUNC int DSCINIT_UhpResponse( UhpResponse *pst );

#include "fasterjson.h"

_WINDLL_FUNC int DSCSERIALIZE_JSON_UhpResponse( UhpResponse *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_UhpResponse( UhpResponse *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_UhpResponse_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_UhpResponse( char *encoding , char *buf , int *p_len , UhpResponse *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_UhpResponse_V( char *encoding , char *buf , int *p_len , void *pv );
